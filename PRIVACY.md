# TimezoneBuddy Privacy Policy

_Last updated: 2026-04-15_

TimezoneBuddy is a browser extension that converts a time across timezones. It is designed to run entirely on your device.

## What we collect

**Nothing.** TimezoneBuddy does not collect, transmit, or share any personal data. There are no analytics, no telemetry, no crash reporting, and no remote servers.

## What the extension accesses

- **Your saved preferences** (target zones, 12/24-hour format, home zone, disambiguation choices) are stored locally using the browser's built-in `storage.sync` API. If you are signed in to your browser profile, these preferences sync between your own devices through your browser vendor (Google or Mozilla) under their respective privacy policies. TimezoneBuddy itself never receives this data.
